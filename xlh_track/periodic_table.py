...
def hypo_gen_and_eval(table, agents, history, logger, max_retries=2):
    ...
    history.update_records(hypothesis, evaluation, match_rate)
    ...
    try:
        for i in range(max_iter):
            ...
            table, history, decision, matched_df = hypo_gen_and_eval(
                table, agents, history, logger, max_retries)
